    ...
    const handleSwipe = async (direction, job) => {
        if (direction === "right") {
            ...
            if (window.chrome && window.chrome.runtime) {
                window.chrome.runtime.sendMessage("mnkbodchklclmmafaclmnjcblmdpgfob", {
                ...
                console.warn("Extension not installed or runtime not available!");
            }
    ...
    return (
        <div className="flex h-[calc(100vh-4rem)] w-full bg-neutral-50 dark:bg-neutral-950 overflow-hidden">
            <div className="w-full h-full relative flex items-center justify-center bg-neutral-100 dark:bg-neutral-950 p-6">
                ...
                <div className="relative w-full max-w-7xl aspect-3/4 xl:aspect-auto xl:h-full xl:max-h-[800px] flex items-center justify-center z-10 animate-in fade-in zoom-in duration-500">
                    <AnimatePresence>
                        {jobs.length > 0 && currentIndex < jobs.length ? (
                            ...
                            <div className="text-center space-y-4 animate-in fade-in zoom-in duration-500">
                                <div className="bg-white dark:bg-neutral-900 p-8 rounded-3xl shadow-xl border border-neutral-200 dark:border-neutral-800">
                                    ...
                                    <Button onClick={resetDeck} className="mt-4 gap-2 bg-indigo-600 hover:bg-indigo-700 text-white">
